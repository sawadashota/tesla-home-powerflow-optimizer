...
func (gq *GrantQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (gq *GrantQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(grant.Table, grant.Columns, sqlgraph.NewFieldSpec(grant.FieldID, field.TypeInt))
	_spec.From = gq.sql
